...
- **Operaciones CRUD Completas:**
  ...
  - ` Editar`: Modifica la información del alumno seleccionado directamente desde la interfaz.
  - ` Eliminar`: Remueve registros con una ventana emergente de confirmación de seguridad.
